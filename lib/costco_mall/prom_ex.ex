defmodule CostcoMall.PromEx do
  @moduledoc """
  ...
  use PromEx, otp_app: :costco_mall
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: CostcoMallWeb.Router, endpoint: CostcoMallWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboard_assigns do
    [
      datasource_id: "PROMETHEUS_COSTCO"
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:costco_mall, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
